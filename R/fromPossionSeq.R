...
#' Esimate sequencing depth
#'
#' Given a data matrix, this function will estimate the sequencing depths on the 
#' basis of the Poisson goodness-of-fit statistic. This estimate is applicable 
#' to data with any types of outcome, as it estimates under the null hypothesis.
#' Function from PossionSeq (https://doi.org/10.1093/biostatistics/kxr031)
#' 
